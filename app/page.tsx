      ...
      <section className="mx-auto grid max-w-6xl gap-10 px-5 py-12 md:grid-cols-2 md:items-center">
        ...
        <div className="rounded-3xl border border-gray-200 bg-gray-50 p-6">
          ...
          <div className="mt-4 grid gap-3">
            <Feature
              title="Hızlı üretim"
              text="Yoğunluğa göre en kısa sürede üretim."
            />
            <Feature
              title="Kaliteli DTF transfer"
              text="Canlı renk, esnek yapı, uzun ömür."
            />
            <Feature
              title="Toplu sipariş"
              text="Kurumsal siparişler için özel fiyat."
            />
            <Feature
              title="Türkiye geneli gönderim"
              text="Kargo ile teslimat opsiyonu."
            />
          </div>
        </div>
      </section>
      ...
      <section id="hizmetler" className="mx-auto max-w-6xl px-5 py-12">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          <Card
            ...
            text="Logo/çizim baskı, esnek ve dayanıklı."
          />
          <Card title="Tekstil Baskı" text="Tişört • Sweatshirt • Şapka • Forma" />
          <Card
            title="Promosyon Ürün"
            text="Kupa • Kalem • Ajanda • Kurumsal set"
          />
        </div>
      </section>
      ...
      <section id="sss" className="mx-auto max-w-6xl px-5 py-12">
        ...
        <div className="mt-6 space-y-3">
          <Faq
            ...
            a="Ürüne göre değişir. Hızlı teklif için WhatsApp’tan yaz."
          />
          <Faq
          ...
          />
          <Faq
            q="DTF baskı dayanıklı mı?"
            a="Uygun yıkama koşullarında uzun ömürlüdür."
          />
        </div>
      </section>
